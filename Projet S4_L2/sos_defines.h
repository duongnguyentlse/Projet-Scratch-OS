...
#define TIMESTAMP_SIZE                                                         \
  24 + 2 // avec \0 et pour que ça tombe juste avec les blocs
#define NB_USERS 5
...
#define INODE_SIZE                                                             \
  FILENAME_MAX_SIZE / BLOCK_SIZE + 6 + (TIMESTAMP_SIZE * 2) / BLOCK_SIZE
...
typedef struct file_s {
  uint size; // Size of file in bytes with pading ie compléter le dernier bloc
             // avec des zéros
